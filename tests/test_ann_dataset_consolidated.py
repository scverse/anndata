...
- Transform classes and multiprocessing compatibility
- DataLoader integration with multiprocessing
...
class TestDataLoaderIntegration:
    """Test DataLoader integration and multiprocessing."""
    ...
    def test_multiprocessing_safety(self, gen_adata):
        """Test multiprocessing safety with transforms."""
        transform = LogTransform()
        dataset = AnnDataset(gen_adata, transform=transform)
