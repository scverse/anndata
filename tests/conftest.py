...
@pytest.fixture
def diskfmt_store(diskfmt: Literal["h5ad", "zarr"]) -> h5py.File | MemoryStore:
    return in_memory_store(diskfmt)


@pytest.fixture
def diskfmt2_store(diskfmt2: Literal["h5ad", "zarr"]) -> h5py.File | MemoryStore:
    return in_memory_store(diskfmt2)
