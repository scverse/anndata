...
def test_daskarray_view_write_fix():
    ...
    print("Confirmed DaskArrayView creation")
    ...
    print("to_dask_array() method works correctly")
...
def test_daskarray_view_in_layers():
    ...
    adata = ad.AnnData(X=dask_X, layers={"test_layer": dask_layer})
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            np.testing.assert_array_equal(
                loaded.layers["test_layer"], layer_data[:10, :5]
            )
