...
def read_lazy(
    ...
    *,
    ...
    store
        ...
        If a path to an h5ad file is provided, the open h5 file will be attached to the {attr}`anndata.AnnData.file` and it will be the user's responsibility to close it when done with the {class}`anndata.AnnData` object.
