...
class LazyCategoricalDtype(pd.CategoricalDtype):
    ...
    def __new__(
        cls,
        categories_elem: zarr.Array | h5py.Dataset | zarr.Group | h5py.Group,
        *,
        ordered: bool = False,
    ):
    ...
    def _get_categories_array(self) -> zarr.Array | h5py.Dataset:
        ...
        handled defensively).
        """
        if isinstance(self._categories_elem, zarr.Array | h5py.Dataset):
