...
_Index = (
    _IndexRest
    | tuple[_Index1D, _IndexRest]
    | tuple[_IndexRest, _Index1D]
    | tuple[_Index1D, _Index1D, EllipsisType]
    | tuple[EllipsisType, _Index1D, _Index1D]
    | tuple[_Index1D, EllipsisType, _Index1D]
    | CSMatrix
    | CSArray
)
